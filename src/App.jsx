...
<p align="justify">Feel free to explore my portfolio and reach out to collaborate!</p>
              <div className="social-links">
                ...
                <a href="https://codeforces.com/profile/Abhay5055" target="_blank" rel="noopener noreferrer" aria-label="Codeforces">
                  <svg width="28" height="28" viewBox="0 0 50 50" fill="currentColor"><circle cx="25" cy="25" r="25" fill="#1f8acb"/><text x="50%" y="55%" text-anchor="middle" fill="#fff" font-size="18" font-family="Arial" dy=".3em">CF</text></svg>
                </a>
              </div>
            </div>
          </section>
          ...
          <footer className="footer">
            <p>&copy; {new Date().getFullYear()} Abhay Bahuguna. All rights reserved.</p>
          </footer>
        </div>
      </div>
    </div>
